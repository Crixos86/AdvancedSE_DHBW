...
\newcommand{\abgabe}{04. April 2023}
\newcommand{\bearbeitungszeitraum}{04.10.2022 - 04.04.2023}
...
\include{Inhalt/05_Inhalt/02_cleanArchitecture}
\include{Inhalt/05_Inhalt/03_SOLID}
\include{Inhalt/05_Inhalt/04_principals}
\include{Inhalt/05_Inhalt/05_unitTests}
\include{Inhalt/05_Inhalt/06_DDD}
\include{Inhalt/05_Inhalt/07_refactoring}
\include{Inhalt/05_Inhalt/08_designPatterns}
